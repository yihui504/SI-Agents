...
| **代码固化 wall-clock 加速比** | SkVM 35x | **50x+**（boost short-circuit，lhs 2.5-3s → rhs <100ms） | **超 SkVM** ✅ |
...
| **compare 实测化** | - | **6/6 项超 SkVM paper** | ✅ |

**全部 6 项超 SkVM 论文数字**（代码固化加速比实测 50x+ 超 SkVM 35x，boost short-circuit 跳过 LLM 是关键）。
